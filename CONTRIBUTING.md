...
find while using `seedcase-flower`. You can do this by creating a
[new](https://github.com/seedcase-project/seedcase-flower/issues/new/choose)
...
To contribute to `seedcase-flower`, you first need to install

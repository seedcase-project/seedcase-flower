# `flora`: A dataset containing flora species records and their observed growth stages across different environments.

**Licenses:** [CCO 1.0 UNIVERSAL](https://creativecommons.org/publicdomain/zero/1.0/legalcode), [Academic Free License 3.0](https://opensource.org/licenses/AFL-3.0)
...
- Jane Dölitz: creator
  ...
  <jane-doelitz@example.com>
- John Smith: author, data collector
...
### Flora Species Locations (`location_catalog`)

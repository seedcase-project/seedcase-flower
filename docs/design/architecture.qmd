...
Flower has a single primary user: someone who publishes Data Package
metadata in a human-readable form. However, this user may interact with
Flower in different ways depending on how much control they want over
the generated output.

-   **Default-mode user:** Uses Flower with its opinionated defaults to
    generate a human-readable representation of a Data Package. Wants a
    high-quality output with minimal configuration and no need for
    customisation.

-   **Custom-mode user:** Uses Flower's configuration options and/or
    templates to control the structure, format, and presentation of the
    output. Wants flexibility to adapt the generated output to specific
    project needs or publishing workflows.

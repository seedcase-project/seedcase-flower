...
The `build()` function has the parameters `source`, `style`, `template_dir`, `output_dir`, and `verbose`. See [`build()`](/docs/reference/build.qmd) for details about these parameters.

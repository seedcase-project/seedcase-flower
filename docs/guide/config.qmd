...
would structure the metadata differently, see
[the Outputs documentation](/docs/design/interface/outputs.qmd).
<!-- TODO change to guide link when available -->
When `template-dir` is used, the structure of the output is determined
by a custom set of templates and configurations explained in

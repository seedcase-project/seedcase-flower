...
uv run seedcase-flower build --source docs/includes/datapackage.json \
...
To add your style to the Examples page, add the link to the folder you just created with the test command above (`docs/examples/your-new-style`) to the list of styles.

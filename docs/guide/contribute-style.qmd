...
uv run seedcase-flower build --source docs/includes/datapackage.json --style your_new_style --output-dir docs/examples/your-new-style
```
...
what the style looks like and how it can be used.

With the testing command above, you will have generated the output files
in the `docs/examples/your-new-style` folder already. You can then link
to these files in the Examples page as is done for the other styles.
